 ...
 * @author Jonwil
 */
public class transferReturn_eliminar extends Instruction{
    public Instruction expression = null;
    public String id   = null;

    public transferReturn_eliminar(String id, Instruction expression, int linea, int col) {
        super(new Tipo(tipoDato.VOID), linea, col);
        this.expression= expression;
    }
    
    
    public transferReturn_eliminar(int linea, int col) {
        super(new Tipo(tipoDato.VOID), linea, col);
    }

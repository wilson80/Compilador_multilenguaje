...
public class MultiplicacionC extends Instruction {
    ...
    public MultiplicacionC(Instruction operando1, Instruction operando2, OperadoresAritmeticos operacion, int linea, int col) {

 ...
 * @author Jonwil
 */
public class CiclicaWhilePas extends Instruction{
    private Instruction expression;
    private LinkedList<Instruction> instructionss;
    private boolean isDoWhile;

    public CiclicaWhilePas(Instruction expression, LinkedList<Instruction> instructionss, boolean isDowhile, int linea, int col) {
...
//            verfify valor de la condicion
        ...
        var newTable = new TablaSimbolos(tabla);
            ...
            for (Instruction instructions : instructionss) {
                ...
                if(value instanceof transferReturn_eliminar){
                    return value;
                } 
                
                if(value instanceof transferContinuePas){
                    break;
                } 
                if(value instanceof transferBreakPas){
                    return null;
                } 

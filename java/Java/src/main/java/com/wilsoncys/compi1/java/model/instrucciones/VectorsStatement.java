...
public class VectorsStatement extends Instruction{
    ...
    public VectorsStatement(boolean isConst, String identificador, Instruction exp1, Tipo tipo, int linea, int col) {
    ...
    public VectorsStatement(boolean isConst, String identificador, 

 ...
 * @author Jonwil
 */
    public class DivisionC extends Instruction {
    ...
    public DivisionC(Instruction operando1, Instruction operando2, OperadoresAritmeticos operacion, int linea, int col) {

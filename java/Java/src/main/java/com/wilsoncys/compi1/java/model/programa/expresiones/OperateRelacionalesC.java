...
public class OperateRelacionalesC extends Instruction {
    ...
    public OperateRelacionalesC(Instruction operando1, Instruction operando2, Relational_LogicalOperations relacion, int linea, int col) {

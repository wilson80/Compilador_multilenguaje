 ...
 * @author Jonwil
 */
public class AccesVector extends Instruction{
    ...
    //vectores 1D
    public AccesVector(String identificador, Instruction requestIndex1, int linea, int col) {
        super(new Tipo(tipoDato.VOID), linea, col);
        this.identificador = identificador;
        this.requestIndex1 = requestIndex1;
    }
    
    public AccesVector(String identificador, Instruction requestIndex1, Instruction requestIndex2, int linea, int col) {
        super(new Tipo(tipoDato.VOID), linea, col);
        this.identificador = identificador;
        this.requestIndex1 = requestIndex1;

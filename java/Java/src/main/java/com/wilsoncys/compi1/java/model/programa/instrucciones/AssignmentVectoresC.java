 ...
 * @author Jonwil
 */
public class AssignmentVectoresC extends Instruction{
...
//asignar en la posicion de un vector una expresion(puede ser el valor de una posicion de otro vector) 
    public AssignmentVectoresC(String identificator1, Instruction index1, Instruction exp, int linea, int col) {
...
//asignacion de vectores 2D
    public AssignmentVectoresC(String identificator1, Instruction index1, Instruction index2, Instruction newExpresion,  int linea, int col) {
        super(new Tipo(tipoDato.VOID), linea, col);
        this.identificator1 = identificator1;
        this.index1 = index1;
        this.index2 = index2;

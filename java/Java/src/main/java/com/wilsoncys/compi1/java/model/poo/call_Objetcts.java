 ...
 * @author Jonwil
 */
public class call_Objetcts extends Instruction{
    private String idRef;
    public String idMethod;
    private LinkedList<Instruction> parametersExp;

    public call_Objetcts(String idObject, String idMethod, LinkedList<Instruction> parametros, int linea, int col) {

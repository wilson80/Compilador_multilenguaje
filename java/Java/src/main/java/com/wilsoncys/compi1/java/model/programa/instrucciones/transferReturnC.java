 ...
 * @author Jonwil
 */
public class transferReturnC extends Instruction{
    public Instruction expression = null;

    public transferReturnC(Instruction expression, int linea, int col) {
        super(new Tipo(tipoDato.VOID), linea, col);
        this.expression = expression;
    }
    
    
    public transferReturnC(int linea, int col) {
        super(new Tipo(tipoDato.VOID), linea, col);
    }
